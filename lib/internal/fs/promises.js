...
async function access(path, mode = F_OK) {
  ...
  if (h !== null) {
    const promise = h.access(path, mode);
...
async function copyFile(src, dest, mode) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.copyFile(src, dest, mode);
    if (promise !== undefined) { await promise; return; }
  }
  return await PromisePrototypeThen(
    binding.copyFile(
...
async function rename(oldPath, newPath) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.rename(oldPath, newPath);
    if (promise !== undefined) { await promise; return; }
  }
...
async function truncate(path, len = 0) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.truncate(path, len);
    if (promise !== undefined) { await promise; return; }
  }
...
async function mkdir(path, options) {
  ...
  if (h !== null) {
    ...
    if (promise !== undefined) return (await promise).result;
  }
...
async function readlink(path, options) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.readlink(path, options);
    if (promise !== undefined) return await promise;
  }
  options = getOptions(options);
...
async function symlink(target, path, type) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.symlink(target, path, type);
    if (promise !== undefined) { await promise; return; }
  }
...
async function link(existingPath, newPath) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.link(existingPath, newPath);
    if (promise !== undefined) { await promise; return; }
  }
...
async function chmod(path, mode) {
  ...
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.chmod(path, mode);
    if (promise !== undefined) { await promise; return; }
  }
...
async function lchmod(path, mode) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.lchmod(path, mode);
    if (promise !== undefined) { await promise; return; }
  }
...
async function lchown(path, uid, gid) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.lchown(path, uid, gid);
    if (promise !== undefined) { await promise; return; }
  }
...
async function chown(path, uid, gid) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.chown(path, uid, gid);
    if (promise !== undefined) { await promise; return; }
  }
...
async function utimes(path, atime, mtime) {
  ...
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.utimes(path, atime, mtime);
    if (promise !== undefined) { await promise; return; }
  }
...
async function realpath(path, options) {
  const h = vfsState.handlers;
  if (h !== null) {
    const promise = h.realpath(path, options);
    if (promise !== undefined) return await promise;
  }
  options = getOptions(options);
  return await PromisePrototypeThen(
...
async function writeFile(path, data, options) {
  ...
  if (h !== null) {
    ...
    const promise = h.writeFile(path, data, options);
    if (promise !== undefined) { await promise; return; }
  }
...
async function appendFile(path, data, options) {
  ...
  if (h !== null) {
    checkAborted(options.signal);
    const promise = h.appendFile(path, data, options);
    if (promise !== undefined) { await promise; return; }
  }
  options = copyObject(options);
  options.flag ||= 'a';
...
async function readFile(path, options) {
  ...
  if (h !== null) {
    checkAborted(options?.signal);
    const result = h.readFile(path, options);
    if (result !== undefined) return result;
  }
